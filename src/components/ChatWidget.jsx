...
const responses = [
  { keys: ['hi', 'hello', 'hey', 'sup', 'yo'], reply: "Hey! 👋 Welcome to The Lawncare Bros. I can help you with pricing, services, or getting a free estimate. What can I help you with today?" },
  ...
  { keys: ['estimate', 'quote', 'free estimate'], reply: "We'd love to give you a free estimate! You can use our Lawn Estimator tool to get an instant range, or call us at (559) 458-3592 to schedule an on-site visit. Which works better for you?" },
  { keys: ['area', 'service area', 'fresno', 'clovis', 'where', 'location'], reply: "We serve Fresno, Clovis, Sanger, Madera, Selma, Reedley, Kerman and surrounding Central Valley areas. Are you in one of these areas?" },
  { keys: ['hours', 'available', 'when', 'schedule', 'open'], reply: "We're available Monday through Saturday, 7AM to 6PM. We also offer early morning slots during hot summer months. Want to schedule something?" },
  { keys: ['license', 'insured', 'bonded', 'insurance'], reply: "Yes! The Lawncare Bros LLC is fully licensed, insured, and bonded. You're in good hands 👍" },
  ...
  { keys: ['thank', 'thanks', 'appreciate'], reply: "You're welcome! 😊 Don't hesitate to reach out anytime. You can also call or text us at (559) 458-3592." },
  { keys: ['bye', 'goodbye', 'later', 'see ya'], reply: "Thanks for chatting! Have a great day 🌿 Call us anytime at (559) 458-3592." },
]

const DEFAULT_REPLY = "That's a great question! For the most accurate answer, give us a call or text at (559) 458-3592 and one of the Bros will help you out personally 👊"
...
export default function ChatWidget() {
  ...
  // Auto-greeting on homepage after 8s
  useEffect(() => {
    ...
    <>
      ...
      {!open && (
        <button className="chat-bubble" onClick={handleOpen} aria-label="Open chat">
          ...
          <span className="chat-bubble__label">Ask The Bros</span>
        </button>
      )}
      ...
      {open && (
        <div className="chat-window">
          <div className="chat-header">
            <img src="/lawncare-bros-logo.png" alt="The Lawncare Bros" className="chat-header__logo" />
            <div className="chat-header__info">
              <span className="chat-header__name">The Lawncare Bros Assistant</span>
